...
public class Teacher extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -6297456141614532481L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Teacher\",\"namespace\":\"poc\",\"fields\":[{\"name\":\"name\",\"type\":\"string\"},{\"name\":\"dept\",\"type\":\"string\"},{\"name\":\"salary\",\"type\":\"long\"}]}");
   ...
   */
  public static BinaryMessageEncoder<Teacher> getEncoder() {
    return ENCODER;
  }
   ...
   * @return a Teacher instance decoded from the given buffer
   ...
   */
  public Teacher(java.lang.CharSequence name, java.lang.CharSequence dept, java.lang.Long salary) {
    this.name = name;
    this.dept = dept;
    this.salary = salary;
  }
   ...
   */
  public static poc.Teacher.Builder newBuilder() {
    return new poc.Teacher.Builder();
  }
   ...
   * @return A new Teacher RecordBuilder
   */
  public static poc.Teacher.Builder newBuilder(poc.Teacher.Builder other) {
    if (other == null) {
      return new poc.Teacher.Builder();
    } else {
      return new poc.Teacher.Builder(other);
    }
  }
   ...
   * @return A new Teacher RecordBuilder
   */
  public static poc.Teacher.Builder newBuilder(poc.Teacher other) {
    if (other == null) {
      return new poc.Teacher.Builder();
    } else {
      return new poc.Teacher.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Teacher>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(poc.Teacher.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(poc.Teacher other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.name)) {
        this.name = data().deepCopy(fields()[0].schema(), other.name);
    ...
    /**
      ...
      * @return This builder.
      */
    public poc.Teacher.Builder setName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public poc.Teacher.Builder clearName() {
      name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public poc.Teacher.Builder setDept(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public poc.Teacher.Builder clearDept() {
      dept = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public poc.Teacher.Builder setSalary(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public poc.Teacher.Builder clearSalary() {
    ...
    public Teacher build() {
      try {
        ...
        record.dept = fieldSetFlags()[1] ? this.dept : (java.lang.CharSequence) defaultValue(fields()[1]);
